    ...
    return (
        <AlertDialog open={open} onOpenChange={toggleOpen}>
            <div className="relative">
                <AlertDialogContent className="flex flex-col gap-5 pt-4! pr-[11px]! pl-5! pb-7.5! rounded-[15px] w-[366px]!">
                    <AlertDialogCancel className="border-none absolute right-0 top-1 h-10">
                        <X />
                    </AlertDialogCancel>
                    ...
                    <AlertDialogHeader className="flex pt-2.5! text-start">
                        ...
                        >
                            ...
                            <div className="flex gap-7">
                                ...
                                <p className="font-medium text-sm leading-6 text-secondColor capitalize">
                                    {orders?.payment_type}
                                </p>
                            </div>
                            ...
                            <div className="flex gap-7">
                                ...
                                {orders.status === "delivered" ? (
                                    <p className="font-medium text-sm text-secondColor leading-6">
                                        Yetkazildi
                                    </p>
